...
define(['angular', 'app', 'text!directives/FullProportionChart/view.html'], function (angular, app, view) {

    app.directive("fullProportionChart", function () {
        return {
            restrict: "E",
            template: view,
            scope: {
            ...
            controller: function ($scope, $FeatureTranslateRule, $timeout, $FullProportionCollection) {
                ...
                $scope.instance = {
                    ...
                    loadByParams: function(params) {
                        $FullProportionCollection.$find({
                            params: params,
                            useCache: true
                        }).$onSuccess(function() {
                            $scope.chart.load($FullProportionCollection.$toJson());
                        });
                    },
