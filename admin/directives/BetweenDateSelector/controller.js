...
define(['angular', 'app', 'text!directives/BetweenDateSelector/view.html', 'configs'], function (angular, app, view) {

    app.directive("betweenDateSelector", function () {
        return {
            restrict: "E",
            template: view,
            scope: {
            ...
            controller: function ($scope) {
                ...
                $scope.onDateChanged = function() {
                    if($scope.startDate&&$scope.endDate){
                        ...
                        $scope.params.endDate = dateTimeFormat($scope.endDate);
                    }
                };
