...
define(['angular', 'app', 'text!directives/CompareSelectorTools/view.html', 'configs', 'EventHero'], function (angular, app, view, configs, EventHero) {

    app.directive("compareSelectorTools", function () {
        return {
            restrict: "E",
            template: view,
            scope: {
