...
require_once( FRAMEWORK_PATH . 'models/SungirlbbList.php' );
...
*	@copyright 2015 synctech.com
*/
class SungirlbbListCollection extends PermissionDbCollection {
	...
	*/
	public function getTable() {
		return "sungirlbb_list";
	}

	public function getModelName() {
		return "SungirlbbList";
	}
