...
define(['angular', 'app', 'text!directives/MonthlySelectorTools/view.html', 'configs', 'EventHero'], function (angular, app, view, configs, EventHero) {

    app.directive("monthlySelectorTools", function () {
        return {
            restrict: "E",
            template: view,
            scope: {
