...
require_once( FRAMEWORK_PATH . '/collections/RawFile/JoinIMediaEventRawTimeInterval.php' );


class iMediaCurveChartEntity extends CurveChartEntity
{
    ...
    public function __construct() {
        ...
        $this->joinStatement    = array(new JoinIMediaEventRawTimeInterval());
    }
